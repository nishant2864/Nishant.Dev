...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://nishantbhardwaj.er'),
  title: {
    default: " — Nishant Bhardwaj's Digital Laboratory",
    template: "%s | Nishant Bhardwaj",
  },
  description:
    "A digital workshop where development meets curiosity. Experiments, prototypes, and open-source artifacts by Nishant Bhardwaj.",
  ...
  authors: [{ name: "Nishant Bhardwaj", url: "https://github.com/nishant2864" }],
  creator: "Nishant Bhardwaj",
  publisher: "Nishant Bhardwaj",
  generator: "v0.app",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "/",
    title: "PORTIFY — Nishant Bhardwaj's Digital Laboratory",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "PORTIFY — Nishant Bhardwaj's Digital Laboratory",
      },
    ],
  },
  twitter: {
